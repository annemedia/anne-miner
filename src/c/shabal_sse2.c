...
static mshabal128_context global_128_sse2;
static mshabal128_context_fast global_128_fast_sse2;  // Added _sse2

void init_shabal_sse2() {
    mshabal_init_sse2(&global_128_sse2, 256);  // Use global_128_sse2
    global_128_fast_sse2.out_size = global_128_sse2.out_size;  // Use _sse2
    for (uint64_t i = 0; i < 176; i++) global_128_fast_sse2.state[i] = global_128_sse2.state[i];  // Use _sse2
    global_128_fast_sse2.Whigh = global_128_sse2.Whigh;  // Use _sse2
    global_128_fast_sse2.Wlow = global_128_sse2.Wlow;  // Use _sse2
}
...
void find_best_deadline_sse2(char *scoops, uint64_t nonce_count, char *gensig,
    ...
    memcpy(&x, &global_128_fast_sse2, sizeof(global_128_fast_sse2));  // Use _sse2
