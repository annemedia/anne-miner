...
static mshabal256_context global_256_avx2;
static mshabal256_context_fast global_256_fast_avx2;

void init_shabal_avx2() {
    mshabal_init_avx2(&global_256_avx2, 256);
    global_256_fast_avx2.out_size = global_256_avx2.out_size;
    for (uint64_t i = 0; i < 352; i++) global_256_fast_avx2.state[i] = global_256_avx2.state[i];
    global_256_fast_avx2.Whigh = global_256_avx2.Whigh;
    global_256_fast_avx2.Wlow = global_256_avx2.Wlow;
}
...
void find_best_deadline_avx2(char *scoops, uint64_t nonce_count, char *gensig,
    ...
    memcpy(&x, &global_256_fast_avx2, sizeof(global_256_fast_avx2));
